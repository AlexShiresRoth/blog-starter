...
const HeroBanner = async (props: UnknownComponent) => {
  ...
  return (
    <div className='w-full  flex gap-4 justify-center  items-center  bg-blue-700 py-14'>
      <div className='w-11/12 md:w-3/4  flex flex-col-reverse md:flex-row gap-4 justify-between items-center '>
        ...
        <div className='relative'>
          ...
          <div className='relative w-[340px] h-[250px] lg:w-[400px] lg:h-[350px] xl:w-[550px] xl:h-[400px]'>
            <Image
              src={hero?.image?.url}
