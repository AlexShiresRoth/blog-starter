      ...
      <div className="container">
        <div className="flex flex-col items-center gap-6">
          ...
          <Carousel className="w-full max-w-6xl">
            <CarouselContent>
              <CarouselItem>
                {/* @TODO fix this it's setting these in one column  */}
                {suggestedPosts.slice(0, 3).map((blogPost) => (
                  <div
                    className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3"
                    key={blogPost.sys.id}
                  >
                    <div className="group overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
